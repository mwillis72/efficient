...
package com.shalom.filemanager.adapters;
...
import com.shalom.filemanager.GlideApp;
import com.shalom.filemanager.R;
import com.shalom.filemanager.activities.superclasses.PreferenceActivity;
import com.shalom.filemanager.adapters.data.IconDataParcelable;
import com.shalom.filemanager.adapters.data.LayoutElementParcelable;
import com.shalom.filemanager.adapters.glide.RecyclerPreloadModelProvider;
import com.shalom.filemanager.adapters.glide.RecyclerPreloadSizeProvider;
import com.shalom.filemanager.adapters.holders.EmptyViewHolder;
import com.shalom.filemanager.adapters.holders.ItemViewHolder;
import com.shalom.filemanager.adapters.holders.SpecialViewHolder;
...
import com.shalom.filemanager.ui.ItemPopupMenu;
import com.shalom.filemanager.ui.colors.ColorUtils;
import com.shalom.filemanager.ui.icons.Icons;
import com.shalom.filemanager.ui.icons.MimeTypes;
import com.shalom.filemanager.ui.views.CircleGradientDrawable;
import com.shalom.filemanager.ui.views.RoundedImageView;
import com.shalom.filemanager.utils.AnimUtils;
import com.shalom.filemanager.utils.GlideConstants;
import com.shalom.filemanager.utils.Utils;
import com.shalom.filemanager.utils.files.CryptUtil;
...
import static com.shalom.filemanager.filesystem.compressed.CompressedHelper.*;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORIZE_ICONS;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_FILE_SIZE;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_GOBACK_BUTTON;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_HEADERS;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_LAST_MODIFIED;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_PERMISSIONS;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_SHOW_THUMB;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_USE_CIRCULAR_IMAGES;
        ...
        if (vholder instanceof ItemViewHolder) {
            ...
            if (mainFrag.IS_LIST) {
                ...
                if (itemsDigested.get(p).getChecked() == ListItem.CHECKED) {
                    ...
                    holder.checkImageView.setVisibility(View.INVISIBLE);
                    if (!((rowItem.filetype == Icons.APK || rowItem.filetype == Icons.IMAGE
                            || rowItem.filetype == Icons.VIDEO) && getBoolean(PREFERENCE_SHOW_THUMB))) {
                        holder.genericIcon.setVisibility(View.VISIBLE);
                        GradientDrawable gradientDrawable = (GradientDrawable) holder.genericIcon.getBackground();
