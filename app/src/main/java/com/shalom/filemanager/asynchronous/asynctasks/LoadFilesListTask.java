...
package com.shalom.filemanager.asynchronous.asynctasks;
...
import com.shalom.filemanager.utils.OnFileFound;
...
public class LoadFilesListTask extends AsyncTask<Void, Void, Pair<OpenMode, ArrayList<LayoutElementParcelable>>> {
     ...
     *
     * @param path the path to the directory tree, starts with prefix {@link com.shalom.filemanager.utils.OTGUtil#PREFIX_OTG}
