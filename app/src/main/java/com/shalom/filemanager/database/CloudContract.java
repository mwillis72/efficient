...
public class CloudContract {
    ...
    public static final String PROVIDER_AUTHORITY = "com.shalom.cloud.provider";

    public static final String PERMISSION_PROVIDER = "com.shalom.cloud.permission.ACCESS_PROVIDER";
