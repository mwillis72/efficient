...
package com.shalom.filemanager.activities;
...
import com.shalom.filemanager.activities.superclasses.PermissionsActivity;
import com.shalom.filemanager.asynchronous.asynctasks.CloudLoaderAsyncTask;
import com.shalom.filemanager.asynchronous.asynctasks.DeleteTask;
import com.shalom.filemanager.asynchronous.asynctasks.MoveFiles;
import com.shalom.filemanager.asynchronous.asynctasks.PrepareCopyTask;
import com.shalom.filemanager.asynchronous.services.CopyService;
import com.shalom.filemanager.database.CloudContract;
import com.shalom.filemanager.database.CloudHandler;
import com.shalom.filemanager.database.CryptHandler;
import com.shalom.filemanager.database.TabHandler;
import com.shalom.filemanager.database.UtilsHandler;
import com.shalom.filemanager.database.models.CloudEntry;
import com.shalom.filemanager.database.models.OperationData;
import com.shalom.filemanager.database.models.Tab;
import com.shalom.filemanager.exceptions.CloudPluginException;
import com.shalom.filemanager.filesystem.FileUtil;
import com.shalom.filemanager.filesystem.HybridFile;
import com.shalom.filemanager.filesystem.HybridFileParcelable;
import com.shalom.filemanager.filesystem.PasteHelper;
import com.shalom.filemanager.filesystem.RootHelper;
import com.shalom.filemanager.filesystem.usb.SingletonUsbOtg;
import com.shalom.filemanager.filesystem.ssh.CustomSshJConfig;
import com.shalom.filemanager.filesystem.ssh.SshConnectionPool;
import com.shalom.filemanager.filesystem.usb.UsbOtgRepresentation;
import com.shalom.filemanager.fragments.AppsListFragment;
import com.shalom.filemanager.fragments.CloudSheetFragment;
import com.shalom.filemanager.fragments.CloudSheetFragment.CloudConnectionCallbacks;
import com.shalom.filemanager.fragments.CompressedExplorerFragment;
import com.shalom.filemanager.fragments.FtpServerFragment;
import com.shalom.filemanager.fragments.MainFragment;
import com.shalom.filemanager.fragments.ProcessViewerFragment;
import com.shalom.filemanager.fragments.SearchWorkerFragment;
import com.shalom.filemanager.fragments.TabFragment;
import com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants;
...
import com.shalom.filemanager.ui.dialogs.RenameBookmark;
import com.shalom.filemanager.ui.dialogs.RenameBookmark.BookmarkCallback;
import com.shalom.filemanager.ui.dialogs.SftpConnectDialog;
import com.shalom.filemanager.ui.dialogs.SmbConnectDialog;
import com.shalom.filemanager.ui.dialogs.SmbConnectDialog.SmbConnectionListener;
import com.shalom.filemanager.ui.views.appbar.AppBar;
import com.shalom.filemanager.ui.views.drawer.Drawer;
import com.shalom.filemanager.utils.BookSorter;
import com.shalom.filemanager.utils.DataUtils;
import com.shalom.filemanager.utils.DataUtils.DataChangeListener;
import com.shalom.filemanager.utils.MainActivityHelper;
import com.shalom.filemanager.utils.OTGUtil;
import com.shalom.filemanager.utils.OpenMode;
import com.shalom.filemanager.utils.PreferenceUtils;
import com.shalom.filemanager.utils.ServiceWatcherUtil;
import com.shalom.filemanager.utils.Utils;
...
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_BOOKMARKS_ADDED;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_COLORED_NAVIGATION;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_NEED_TO_SET_HOME;
import static com.shalom.filemanager.fragments.preference_fragments.PreferencesConstants.PREFERENCE_VIEW;
//ads
...
public class MainActivity extends PermissionsActivity implements SmbConnectionListener,
    ...
    public static final String CLOUD_AUTHENTICATOR_REDIRECT_URI = "com.shalom.filemanager:/auth";
...
//ca-app-pub-9129589479375926~9575692259
//        MobileAds.initialize(this, "ca-app-pub-9129589479375926~9575692259");
//        mInterstitialAd = new InterstitialAd(this);
...
//        }else{
//            Toast.makeText(this,"Ad not yet loaded",1);
//        }
        ...
        switch (item.getItemId()) {
            case R.id.home:
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    Toast.makeText(this,"Ad not yet loaded",Toast.LENGTH_LONG);
                    showToast(getString(R.string.pressagain));
                }
                if (ma != null)
                    ma.home();
