...
import com.shalom.filemanager.asynchronous.asynctasks.ReadFileTask;
import com.shalom.filemanager.asynchronous.asynctasks.SearchTextTask;
import com.shalom.filemanager.asynchronous.asynctasks.WriteFileAbstraction;
import com.shalom.filemanager.filesystem.EditableFileAbstraction;
...
import com.shalom.filemanager.utils.MapEntry;
...
public class TextEditorActivity extends ThemedActivity implements TextWatcher, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ActivityManager.TaskDescription taskDescription = new ActivityManager.TaskDescription("Efficient",
