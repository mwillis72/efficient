...
package com.shalom.filemanager.fragments.preference_fragments;
...
import com.shalom.filemanager.activities.AboutActivity;
...
import com.shalom.filemanager.ui.views.preference.CheckBox;
...
import static com.shalom.filemanager.R.string.feedback;
import static com.shalom.filemanager.activities.PreferencesActivity.START_PREFERENCE;
        ...
        switch (preference.getKey()) {
            ...
            case PreferencesConstants.FRAGMENT_FEEDBACK:
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                        "mailto", "willismshindi77@gmail.com", null));
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Feedback : Efficient File Manager");
                ...
                if (isIntentSafe)
                    ...
                    Toast.makeText(getActivity(), getResources().getString(R.string.send_email_to)
                            + " willismshindi77@gmail.com", Toast.LENGTH_LONG).show();
                return false;
            case PreferencesConstants.FRAGMENT_ABOUT:
                MobileAds.initialize(getActivity(), "ca-app-pub-9129589479375926~9575692259");
                ...
                if (mInterstitialAd.isLoaded()) {
                    ...
                    Toast.makeText(getActivity(),"Ad not yet loaded",1);
                }
