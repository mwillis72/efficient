package com.shalom.filemanager.ui.colors;
...
public class ColorPreferenceHelper {
    ...
    public static final @ColorRes int DEFAULT_PRIMARY_FIRST_TAB = R.color.primary_pink,
            DEFAULT_PRIMARY_SECOND_TAB = R.color.primary_pink,
    ...
    private static final @ColorRes int[][] RANDOM_COMBINATIONS = new int[][]{
            ...
            {R.color.primary_pink, R.color.primary_pink, R.color.primary_pink},
    ...
    private boolean isUsingOldColorsSystem(SharedPreferences prefs) {
        int tabOne = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_pink);
        int tabTwo = prefs.getInt(PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_pink);
    ...
    private @ColorInt int correctForIndex(Context c, int color) {
        ...
        else return Utils.getColor(c, R.color.primary_pink);
    }
