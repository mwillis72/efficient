...
import com.shalom.filemanager.ui.colors.UserColorPreferences;
import com.shalom.filemanager.ui.views.CircularColorsView;
import com.shalom.filemanager.ui.views.preference.SelectedColorsPreference;
...
public class ColorPickerDialog extends SelectedColorsPreference {
    ...
    private static final ColorItemPair[] COLORS = new ColorItemPair[]{
            new ColorItemPair(R.string.defualt,
                    new int[]{R.color.primary_pink, R.color.primary_pink, R.color.primary_pink, R.color.accent_pink}),
    ...
    public void onBindDialogView(View view) {
        ...
        if(selectedIndex == NO_DATA) {//if instance was restored the value is already set
            boolean isUsingDefault = sharedPrefs.getInt(PreferencesConstants.PREFERENCE_COLOR_CONFIG, NO_DATA) == NO_DATA
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_SKIN, R.color.primary_pink) == R.color.primary_pink
                    && sharedPrefs.getInt(PreferencesConstants.PREFERENCE_SKIN_TWO, R.color.primary_pink) == R.color.primary_pink
