...
package com.shalom.filemanager.ui.views.drawer;
...
import com.shalom.filemanager.activities.PreferencesActivity;
...
import com.shalom.filemanager.fragments.preference_fragments.QuickAccessPref;
...
import com.shalom.filemanager.utils.ScreenUtils;
import com.shalom.filemanager.utils.TinyDB;
...
public class Drawer implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public Drawer(MainActivity mainActivity) {
        ...
        if (mainActivity.getAppTheme().equals(AppTheme.TIMED)) {
