...
package com.shalom.filemanager.filesystem.ssh;
...
import com.shalom.filemanager.asynchronous.asynctasks.ssh.SshAuthenticationTask;
...
public class SshConnectionPool
{
    ...
    /**
     * Kill any connection that is still in place. Used by {@link com.shalom.filemanager.activities.MainActivity}.
     *
    ...
    static final class ConnectionInfo {
        ...
        ConnectionInfo(@NonNull String url){
            if(!url.startsWith(SSH_URI_PREFIX))
                throw new IllegalArgumentException("Argument is not an SSH URI: " + url);
