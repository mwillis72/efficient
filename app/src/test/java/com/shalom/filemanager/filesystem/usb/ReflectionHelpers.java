package com.shalom.filemanager.filesystem.usb;
...
class ReflectionHelpers {
    ...
    static void addUsbOtgDevice(Activity activity) {
        ...
        try {
            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                device = callUsbDeviceConstructor("usb", 0, 0,
                        USB_CLASS_MASS_STORAGE, 0, 0, configureUsbDevice());
            }
        } catch (Exception e) {
    ...
    static void configureUsbDevice(UsbDevice device) throws NoSuchMethodException,
        ...
        Method configureMethod = device.getClass().getDeclaredMethod("setConfigurations", Parcelable[].class);
    ...
    static Parcelable[] configureUsbDevice() throws ClassNotFoundException, NoSuchMethodException,
            InvocationTargetException, InstantiationException, IllegalAccessException {
        UsbInterface usbInterface = (UsbInterface) callUsbInterfaceConstructor(01,
                USB_CLASS_MASS_STORAGE, 0, 0, null);
    ...
    static UsbDevice callUsbDeviceConstructor(@NonNull String name, int vendorId, int productId,
        ...
        Constructor<UsbDevice> constructor = clazz.getConstructor(String.class,
                int.class, int.class, int.class, int.class, int.class, String.class, String.class,
                String.class, String.class);

        return constructor.newInstance(name, vendorId, productId, usbClass, subClass, protocol,
    ...
    static UsbDevice callUsbDeviceConstructor(@NonNull String name, int vendorId, int productId,
        ...
        Class<UsbDevice> clazz = (Class<UsbDevice>) Class.forName("android.hardware.usb.UsbDevice");
        Constructor<UsbDevice> constructor = clazz.getConstructor(String.class,
                int.class, int.class, int.class, int.class, int.class, Parcelable[].class);

        return constructor.newInstance(name, vendorId, productId, usbClass, subClass, protocol, interfaces);
    }
    ...
    static UsbConfiguration callUsbConfigurationConstructor(int id, @Nullable String name,
        ...
        Constructor<UsbConfiguration> constructor = clazz.getConstructor(int.class,  String.class,
                int.class, int.class);
    ...
    static UsbInterface callUsbInterfaceConstructor(int id, int alternateSetting,
        ...
        Constructor<UsbInterface> constructor = clazz.getConstructor(int.class, int.class, String.class,
    ...
    static UsbInterface callUsbInterfaceConstructor(int id, int usbClass, int subClass, int protocol,
        ...
        Class<UsbInterface> clazz = (Class<UsbInterface>) Class.forName("android.hardware.usb.UsbInterface");
        Constructor<UsbInterface> constructor = clazz.getConstructor(int.class, int.class,
